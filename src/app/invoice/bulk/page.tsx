    ...
    return (
        <>
            ...
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .inv-summary { max-width: 780px; margin: 0 auto; padding: 0 32px 24px; font-size: 13px; color: #888; }
                @media print { .inv-print-btn { display: none !important; } .inv-summary { display: none !important; } }
            ...
            <div className="invoice-wrap">
                {orders.flatMap((order: any) => {
                    ...
                    return pages.map((pageItems, pageIdx) => (
                        <div key={`${order.id}-${pageIdx}`} className="inv-page">
